    ...
    public static class ModelBuilderExtensions
    {
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Produto>().HasData(
                    new Produto() { Id = 1, NomeArquivo="xx.jpg", Nome = "Picanha", TipoProdutoId = 1, Preco = 90.5M },
                    new Produto() { Id = 2, NomeArquivo = "xx.jpg", Nome = "Pasta de Dente Colgate", TipoProdutoId = 2, Preco = 9.5M },
                    new Produto() { Id = 3, NomeArquivo = "xx.jpg", Nome = "Fraldas Pampers", TipoProdutoId = 2, Preco = 80.5M },
                    new Produto() { Id = 4, NomeArquivo = "xx.jpg", Nome = "Tenis Nike", TipoProdutoId = 3, Preco = 280.5M }
                );
